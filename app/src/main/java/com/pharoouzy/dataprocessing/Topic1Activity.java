...
public class Topic1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = Topic1Activity.this;
        // initializing titleArrayList
        titleArrayList = new ArrayList<String>();
        titleArrayList.add(Constants.INTRODUCTION);
        titleArrayList.add(Constants.TYPES_OF_DATA_MODELS);
        titleArrayList.add(Constants.DATA_MODELLING);
        titleArrayList.add(Constants.NORMAL_FORMS);
        titleArrayList.add(Constants.ENTRY_RELATIONAL_MODEL);
        titleArrayList.add(Constants.RELATIONAL_MODEL);
        titleArrayList.add(Constants.FILE_ORGANIZATION);
        ...
        TitleAdapter adapter = new TitleAdapter(mContext, titleArrayList, new CustomItemClickListener() {
            ...
            public void onItemClick(View v, int position) {
                Intent intent = new Intent(Topic1Activity.this, ContentsActivity.class);
                intent.putExtra("titles", titleArrayList.get(position));
                startActivity(intent);
                //Toast.makeText(Topic1Activity.this, "Clicked "+titleArrayList.get(position), Toast.LENGTH_SHORT).show();
            }
        });
